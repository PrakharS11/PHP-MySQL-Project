...
.greenbtn {
    background-color: rgb(244,25,102);
    color: white;
    width: 95%;
    height: 40px;
    margin-top: 8px;
   ...
   include("data_class.php");
    ?>
           <div class="container">
            ...
            <p style="color:black"><u>Employee Name:</u> &nbsp&nbsp<?php echo $name ?></p>
            <p style="color:black"><u>Employee Email:</u> &nbsp&nbsp<?php echo $email ?></p>
            <p style="color:black"><u>Employee Salary:</u> &nbsp&nbsp<?php echo $salary ?> lp</p>
